        ...
        {!isEmailSent && 
          <form action='' onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
            ...
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
              ...
              <input required value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder='Email id' className='text-white bg-transparent outline-none'/>
            </div>
       ...
       {isOtpSubmit && isEmailSent && 
          <form onSubmit={onSubmitNewPassword} action="" className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
            ...
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
              ...
              <input required onChange={e => setNewPassword(e.target.value)} value={newPassword} type="password" placeholder='Password' className='text-white bg-transparent outline-none'/>
            </div>
            <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3'>Submit</button>
          </form>
        }
