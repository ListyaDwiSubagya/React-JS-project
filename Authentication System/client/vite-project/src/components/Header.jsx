...
const Header = () => {
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis blanditiis facere tempora! Quibusdam sit mollitia neque, tenetur consequatur exercitationem odio rem blanditiis modi, quam magni.</p>
